...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by chockwang on 2017/7/15.
	 */

	var first=document.querySelector("#first");    //这里用document.getElementById没用
	...
	btn.onclick=function(){
	    ...
	    last.value=add(parseFloat(first.value),parseFloat(second.value))
	}
